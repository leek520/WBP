    ...
    ui(new Ui::TextEdit)
{
   ...
   // {
    ...
    left = new QAction(QIcon(":/textleft"),tr("左对齐"),actGrp);
    left->setCheckable(true);
    center = new QAction(QIcon(":/textcenter"),tr("居中对齐"),actGrp);
    center->setCheckable(true);
    right = new QAction(QIcon(":/textright"),tr("右对齐"),actGrp);
    right->setCheckable(true);
    justify = new QAction(QIcon(":/textjustify"),tr("两端对齐"),actGrp);
    ...
    listBox->addItem(tr("ⅰ ⅱ ⅲ ...(Roman lower)"));
