...
MdiChild::MdiChild(QWidget *parent) : CodeEditor(parent)
{
    this->setAcceptDrops(false);
    this->setTextFont(18);  //设置字体大小
    this->setHighLightColor(QColor(175, 238, 238, 255));
...
{
    /**自定义的右键菜单项目**/
   actUndo = new QAction(QIcon("../resources/images/undo.png"),tr("撤销"),this);
   ...
   actRedo = new QAction(QIcon(":/redo"),tr("重复"),this);
   ...
   actCut = new QAction(QIcon(":/cut"),tr("剪切"),this);
   ...
   actCopy = new QAction(QIcon(":/copy"),tr("复制"),this);
   ...
   actPaste = new QAction(QIcon(":/paste"),tr("粘贴"),this);
   ...
   actDel = new QAction(QIcon(":/stock_delete"),tr("删除"),this);
